    ...
    <section className="mb-8">
      <div className="rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 overflow-hidden shadow-sm">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_240px] gap-0">
          ...
          <aside className="border-t lg:border-t-0 lg:border-l border-slate-200 dark:border-slate-800 bg-slate-50/40 dark:bg-slate-950/30 p-3 sm:p-4 max-h-[560px] overflow-y-auto">
